...
app.use(function (req, res, next) {
  // make our markdown function avalable from within ejs template
...
io.on("connection", function (socket) {
  if (socket.request.session.user) {
    ...
    socket.on("chatMessageFromBrowser", function (data) {
      socket.broadcast.emit("chatMessageFromServer", { message: sanitizeHTML(data.message), username: user.username, avatar: user.avatar })
    })
  }
})
